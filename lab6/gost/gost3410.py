...
from gost.gost341194 import GOST341194
from gost.utils import bytes2long
from gost.utils import hexdec
from gost.utils import long2bytes
from gost.utils import modinvert
...
def sign_3411(curve, prv, pub, ukm):
    ...
    :type pub: (long, long)
    :param bytes ukm: user keying material, VKO-factor
    ...
    key = curve.exp(curve.cofactor * bytes2long(ukm[::-1]), key[0], key[1])
